...
class AC:
    ...
    def __init__(self, zero_run_length: int, amplitude: int):
        # {zero run length, size} {amplitude}
        ...
        self.__zero_run_length = zero_run_length
        self.__size = len(self.__amplitude_bits)

        self.__position_bits = AC.k5.get((self.__zero_run_length, self.__size))

    @property
    def stream(self):
        return "{position_bits}{signal_bits}{amplitude_bits}".format(
            position_bits=self.__position_bits,
    ...
    @property
    def zero_run_length(self) -> int:
        return self.__zero_run_length
